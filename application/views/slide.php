    ...
    <style> 
        ...
        .bricon
        {
            background: url('<?php echo base_url('assets'); ?>/slide/img/browser-icons.png');
        }
    </style>
    <!-- it works the same with all jquery version from 1.x to 2.x -->
    <script type="text/javascript" src="<?php echo base_url('assets'); ?>/slide/js/jquery-1.9.1.min.js"></script>
    <!-- use jssor.slider.mini.js (40KB) instead for release -->
    <!-- jssor.slider.mini.js = (jssor.js + jssor.slider.js) -->
    <script type="text/javascript" src="<?php echo base_url('assets'); ?>/slide/js/jssor.js"></script>
    <script type="text/javascript" src="<?php echo base_url('assets'); ?>/slide/js/jssor.slider.js"></script>
    <script>
        ...
        jQuery(document).ready(function ($) {
            ...
            function ScaleSlider() {
                ...
                if (parentWidth)
                    jssor_slider1.$ScaleWidth(Math.max(Math.min(parentWidth, 3000), 440));
                else
    ...
    <div id="slider1_container" style="position: relative; width:1300px;
        ...
        <div u="loading" style="position: absolute; top: 0px; left: 0px;">
            ...
            <div style="position: absolute; display: block; background: url('<?php echo base_url('assets'); ?>/slide/img/loading.gif') no-repeat center center;
        ...
        <!-- Slides Container --> 
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1300px; height: 560px;
            overflow: hidden;">
            <div>
                <img u="image" src="<?php echo base_url('assets'); ?>/slide/img/home/01.jpg" />
                <div u=caption t="CLIP|LR" du="1500" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:500px; height:30px;"> 
               Découvrez toutes les nouvelles technologies du web
                </div>
                ...
                <div u="caption" t="ZMF|10" t2="B" d=-1300 style="position:absolute;left:420px;top:280px;width:90px;height:40px;font-size:36px;color:#fff;line-height:40px;">Java</div>
                <div u="caption" t="CLIP|L" d=-300 style="position:absolute;left:520px;top:280px;width:160px;height:40px;font-size:36px;color:#fff;line-height:40px; text-align: center;">Ruby</div>
                <a class="captionOrange" u="caption" t="CLIP|L" d=-300 href="http://www.jssor.com/development/tool-caption-transition-viewer.html" style="position:absolute;left:720px;top:280px;width:220px;height:40px;font-size:36px;color:#fff;line-height:40px;">Android</a>
            </div>
            <div> 
                <img u="image" src="<?php echo base_url('assets'); ?>/slide/img/home/02.jpg" />
                <a class="captionOrange" href="http://www.jssor.com/development/tool-slideshow-transition-viewer.html" style="position: absolute; top: 300px; left: 630px; width: 250px; height: 30px;">Frameworks</a>
                ...
                <div u="caption" t="MCLIP|T" t2="T" d=-450 style="position:absolute;left:505px;top:40px;width:200px;height:30px;font-size:18px;color:#fff;line-height:30px;text-align:center;">Level</div>
                <div u="caption" t="MCLIP|R" d=-300 style="position:absolute;left:325px;top:90px;width:350px;height:30px;font-size:18px;color:#fff;line-height:30px;">JEE &nbsp; &nbsp; &nbsp; &nbsp; ~90%</div>
                <div u="caption" t="MCLIP|R" d=-300 style="position:absolute;left:325px;top:140px;width:350px;height:30px;font-size:18px;color:#fff;line-height:30px;">Wordpress &nbsp; &nbsp; &nbsp; &nbsp; ~70%</div>
                <div u="caption" t="MCLIP|R" d=-300 style="position:absolute;left:325px;top:190px;width:350px;height:30px;font-size:18px;color:#fff;line-height:30px;">PHP&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ~100%</div>
            </div>
             <!--
            <div> 
                <img u="image" src="<?php echo base_url('assets'); ?>/slide/img/home/03.jpg" />
            ...
            -->
            <div>
                <img u="image" src="<?php echo base_url('assets'); ?>/slide/img/home/04.jpg" />
               ...
               Tous les périphériques
                ...
                <img u="caption" t="T|IB" t2=B d=-900 src="<?php echo base_url('assets'); ?>/slide/img/home/moc-iphone.png" style="position:absolute;left:600px;top:230px;width:120px;height:80px;" />
                <img u="caption" t="RTTL|BR" d=-450 src="<?php echo base_url('assets'); ?>/slide/img/home/moc-ipad.png" style="position:absolute;left:750px;top:220px;width:77px;height:100px;" />
            </div>
            ...
            <style>
                .share-icon {
                    ...
                    background-image: url('<?php echo base_url('assets'); ?>/slide/img/share/share-icons.png');
                }
        ...
        <style>
            ...
            */
            ...
            .jssorb03 div, .jssorb03 div:hover, .jssorb03 .av {
                ...
                color: white;
                font-size: 12px;
                background: url('<?php echo base_url('assets'); ?>/slide/img/b03.png') no-repeat;
                overflow: hidden;
                cursor: pointer;
            }
        ...
        <style>
            ...
            */
            .jssora20l, .jssora20r {
                ...
                height: 55px;
                cursor: pointer;
                background: url('<?php echo base_url('assets'); ?>/slide/img/a20.png') no-repeat;
                overflow: hidden;
            }
