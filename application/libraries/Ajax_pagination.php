...
class Ajax_pagination{
    ...
    var $first_link      = '|<';  // Premier élément (First)
    var $next_link       = '&#187;';
    var $prev_link       = '&#171;';
    var $last_link       = '>|';  // Dernier élément (Last)
    var $uri_segment     = 3;
    ...
    function create_links(){
        ...
        if ($num_pages == 1){
            $info = '<h4>Cours disponibles : ' . $this->total_rows.'</h4>';
            return $info;
        }
        ...
        if ($this->show_count){
            ...
            $info = 'Affichage de ' . ( $curr_offset + 1 ) . ' à ' ;
